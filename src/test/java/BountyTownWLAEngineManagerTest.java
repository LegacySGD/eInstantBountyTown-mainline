...
public class BountyTownWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(BountyTownWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/BountyTownIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/BountyTownIW/InitOutcome.xml").getDocumentElement();
